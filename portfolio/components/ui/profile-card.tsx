...
export function ProfileCard({
  name = "Ahmed Salah",
  title = "Motion Graphics Designer & Video Editor | 100% Success Rate",
  avatarUrl = "https://i.ibb.co/Kc3MTRNm/caarton-character.png",
  backgroundUrl = "https://images.unsplash.com/photo-1633356122544-f134324ef6db?w=500&h=300&fit=crop",
  likes = 72900,
  posts = 828,
  views = 342900,
  instagramUrl = "https://instagram.com/dds.ahmedsalah",
  ...
  return (
    <div className="w-full max-w-sm mx-auto">
      <div className="bg-card rounded-[2rem] shadow-lg overflow-hidden">
        <div className="relative h-40 bg-gradient-to-br from-cyan-600 to-purple-600 overflow-hidden">
          <img
