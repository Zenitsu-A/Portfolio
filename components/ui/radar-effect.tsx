  ...
  return (
    ...
    <div
      ...
      className={twMerge(
        ...
        "relative flex h-20 w-20 items-center justify-center rounded-full scale-90",
...
export const IconContainer = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-gray-700 bg-gray-800 shadow-inner">
